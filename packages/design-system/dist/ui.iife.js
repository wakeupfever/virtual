var DesignSystemUI = (function(exports, vue, element_plus) {
	...
	//#region ui/UiShellMenu.vue?vue&type=script&setup=true&lang.ts
	var _hoisted_1$8 = {
		key: 0,
	...
	var _hoisted_9$1 = ["d"];
	var _hoisted_10$1 = { class: "ui-shell__text" };
	var _hoisted_11$1 = {
		key: 0,
		class: "ui-shell__badge"
	};
		...
		setup(__props) {
			...
			*/
			...
			return (_ctx, _cache) => {
				...
				return (0, vue.openBlock)(true), (0, vue.createElementBlock)(vue.Fragment, null, (0, vue.renderList)(__props.items, (item) => {
					return (0, vue.openBlock)(), (0, vue.createElementBlock)(vue.Fragment, { key: item.key }, [item.group ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("div", _hoisted_1$8, [(0, vue.createElementVNode)("span", null, (0, vue.toDisplayString)(item.group), 1)])) : (0, vue.createCommentVNode)("", true), item.children && item.children.length ? ((0, vue.openBlock)(), (0, vue.createBlock)((0, vue.unref)(element_plus.ElSubMenu), {
						key: 1,
						index: item.key,
				...
				return (0, vue.openBlock)(), (0, vue.createElementBlock)("div", { class: (0, vue.normalizeClass)(["ui-shell", {
					...
					!isMobile.value ? ((0, vue.openBlock)(), (0, vue.createElementBlock)("aside", {
						...
						default: (0, vue.withCtx)(() => [(0, vue.createVNode)((0, vue.unref)(element_plus.ElMenu), {
							...
							default: (0, vue.withCtx)(() => [(0, vue.createVNode)(UiShellMenu_default, { items: __props.menu }, null, 8, ["items"])]),
							_: 1
